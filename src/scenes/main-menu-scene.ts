...
import snakeFontImage from '../assets/snakeFont.png';
import snakeFontFnt from '../assets/snakeFont.xml';
...
export class MainMenuScene extends Phaser.Scene {
  ...
  preload(): void {
    this.load.bitmapFont('snakeFont', snakeFontImage, snakeFontFnt);
  }
