...
import { setupSound } from '../objects/Audio';
import { Player } from '../objects/Player';

export class GameScene extends Phaser.Scene {
  private finalTally = 0;
  private level2BlockPlayer = true;
  private level3BlockPlayer = true;
  private lightsArray: Phaser.Tilemaps.TilemapLayer[] = [];
  private fSpawnPoint: Phaser.Types.Tilemaps.TiledObject;
  private level2BlockPos: Phaser.Types.Tilemaps.TiledObject;
  private level2Blocker: Phaser.Physics.Arcade.Sprite & {
    body: Phaser.Physics.Arcade.Body;
  };
  private level3BlockPos: Phaser.Types.Tilemaps.TiledObject;
  ...
  create() {
    ...
    const grass = map.createLayer(0, tileSetImg, 0, 0);
    const tiles = map.createLayer(1, [tileSetImg, tileLightSetImg], 0, 0);
    const walls = map.createLayer(2, tileSetImg, 0, 0);
    const wallTop = map.createLayer(3, tileSetImg, 0, 0).setDepth(12);
    const enemyColl = map.createLayer(4, tileSetImg);
    // Light layers below
    const lightLayerStart = map.createLayer(5, [tileSetImg, tileLightSetImg]);
    const lightLayer1 = map.createLayer(6, [tileSetImg, tileLightSetImg]);
    const lightLayer2 = map.createLayer(7, [tileSetImg, tileLightSetImg]);
    const lightLayer3 = map.createLayer(8, [tileSetImg, tileLightSetImg]);
    const lightLayer4 = map.createLayer(9, [tileSetImg, tileLightSetImg]);
    const lightLayer5 = map.createLayer(10, [tileSetImg, tileLightSetImg]);
    const lightLayer6 = map.createLayer(11, [tileSetImg, tileLightSetImg]);
    const lightLayer7 = map.createLayer(12, [tileSetImg, tileLightSetImg]);
    const lightLayer8 = map.createLayer(13, [tileSetImg, tileLightSetImg]);
    const lightLayer9 = map.createLayer(14, [tileSetImg, tileLightSetImg]);
    const lightLayer10 = map.createLayer(15, [tileSetImg, tileLightSetImg]);
    const lightLayer11 = map.createLayer(16, [tileSetImg, tileLightSetImg]);
    const lightLayer12 = map.createLayer(17, [tileSetImg, tileLightSetImg]);
    const lightLayer13 = map.createLayer(18, [tileSetImg, tileLightSetImg]);
    const lightLayer14 = map.createLayer(19, [tileSetImg, tileLightSetImg]);
    const lightLayer15 = map.createLayer(20, [tileSetImg, tileLightSetImg]);
    const lightLayer16 = map.createLayer(21, [tileSetImg, tileLightSetImg]);
    const lightLayer17 = map.createLayer(22, [tileSetImg, tileLightSetImg]); // Layer 23
