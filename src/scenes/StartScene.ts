export class StartScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('spikeT', 'assets/spritesheets/Spike.png', {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet('light_orb', 'assets/spritesheets/light_ORB.png', {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet('sparkle', 'assets/spritesheets/sparkle.png', {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet(
